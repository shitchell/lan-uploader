...
description: "DO NOT launch with Task. Launch via Bash: claude --agent feature-supervisor --dangerously-skip-permissions -p \"You are the feature-supervisor (Supervisor1). Your job is to oversee feature implementation for ticket_dir: {ticket_dir}\""
model: inherit
---
...
```bash
claude --dangerously-skip-permissions -p "You are a chunk supervisor for the feature workflow.
